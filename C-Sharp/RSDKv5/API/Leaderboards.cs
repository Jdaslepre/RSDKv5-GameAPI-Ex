...
public unsafe class Leaderboards
{
    ...
    public static void Fetch(ref LeaderboardID leaderboard, bool32 isUser) => APITable.FetchLeaderboard(ref leaderboard, isUser);
    public static void TrackScore(ref LeaderboardID leaderboard, int score, delegate* unmanaged<bool32, int, void> callback) => APITable.TrackScore(ref leaderboard, score, callback);
